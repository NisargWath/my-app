...
```mermaid
graph TD
  aa212c89["ERC-721 NFT"]
  99a621a6["Frontend"]
  a368983e["Wallet Auth"]
  aa212c89 --> 99a621a6
  99a621a6 --> a368983e
```
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--aa212c89.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--99a621a6.md`
3. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--a368983e.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--aa212c89.md)
- [Frontend](.nskills/components/frontend-scaffold--99a621a6.md)
- [Wallet Auth](.nskills/components/wallet-auth--a368983e.md)
